...
const themeStyles = {
  music: {
    ...
    btnGradient:
      'bg-gradient-to-r from-amber-400 via-yellow-400 to-amber-500 text-slate-950 shadow-amber-400/25 border-amber-400',
  ...
  movies: {
    ...
    btnGradient:
      'bg-gradient-to-r from-purple-500 via-indigo-500 to-purple-600 text-white shadow-purple-500/25 border-purple-400',
  ...
  maps: {
    ...
    btnGradient:
      'bg-gradient-to-r from-emerald-500 via-teal-500 to-emerald-600 text-white shadow-emerald-500/25 border-emerald-400',
...
export function CategoryCard({
  ...
  return (
    <div className="space-y-5 -translate-x-1.5">
